...
from google.cloud.logging_v2.handlers._monitored_resources import _create_functions_resource
from google.cloud.logging_v2.handlers._monitored_resources import _create_app_engine_resource
from google.cloud.logging_v2.handlers._monitored_resources import _create_kubernetes_resource
from google.cloud.logging_v2.handlers._monitored_resources import _create_cloud_run_resource
from google.cloud.logging_v2.handlers._monitored_resources import _create_compute_resource
from google.cloud.logging_v2.handlers._monitored_resources import _create_global_resource
...
class Test_Create_Resources(unittest.TestCase):
    ...
    def _mock_metadata(self, endpoint):
        ...
        elif (endpoint == _monitored_resources._GKE_CLUSTER_NAME
...
class Test_Resource_Detection(unittest.TestCase):
    ...
    def _mock_k8s_metadata(self, endpoint):
        if (endpoint == _monitored_resources._GKE_CLUSTER_NAME
                or endpoint == _monitored_resources._GCE_INSTANCE_ID):
            return "TRUE"
        else:
            return None
