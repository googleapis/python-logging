...
class TestConfigServiceV2Client(object):
    ...
    def test_get_bucket(self):
        ...
        expected_response = {'name': name_2, 'description': description, 'retention_days': retention_days}
    ...
    def test_update_bucket(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.UpdateBucketRequest(name=name, bucket=bucket, update_mask=update_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_sink(self):
        ...
        expected_response = {'name': name, 'destination': destination, 'filter': filter_, 'description': description, 'disabled': disabled, 'writer_identity': writer_identity, 'include_children': include_children}
    ...
    def test_create_sink(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.CreateSinkRequest(parent=parent, sink=sink)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_sink(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.UpdateSinkRequest(sink_name=sink_name, sink=sink)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_exclusions(self):
        ...
        expected_response = logging_config_pb2.ListExclusionsResponse(**expected_response)
    ...
    def test_get_exclusion(self):
        ...
        filter_ = 'filter-1274492040'
        disabled = True
        expected_response = {'name': name_2, 'description': description, 'filter': filter_, 'disabled': disabled}
    ...
    def test_create_exclusion(self):
        ...
        filter_ = 'filter-1274492040'
        disabled = True
        expected_response = {'name': name, 'description': description, 'filter': filter_, 'disabled': disabled}
        expected_response = logging_config_pb2.LogExclusion(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.CreateExclusionRequest(parent=parent, exclusion=exclusion)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_exclusion(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.UpdateExclusionRequest(name=name, exclusion=exclusion, update_mask=update_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_cmek_settings(self):
        ...
        expected_response = {'name': name_2, 'kms_key_name': kms_key_name, 'service_account_id': service_account_id}
    ...
    def test_update_cmek_settings(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_config_pb2.UpdateCmekSettingsRequest(name=name, cmek_settings=cmek_settings)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
