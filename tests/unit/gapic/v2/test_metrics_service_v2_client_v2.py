...
class TestMetricsServiceV2Client(object):
    ...
    def test_update_log_metric(self):
        ...
        expected_response = {'name': name, 'description': description, 'filter': filter_, 'value_extractor': value_extractor}
        ...
        expected_request = logging_metrics_pb2.UpdateLogMetricRequest(metric_name=metric_name, metric=metric)
    ...
    def test_list_log_metrics(self):
        ...
        expected_response = logging_metrics_pb2.ListLogMetricsResponse(**expected_response)
    ...
    def test_create_log_metric(self):
        ...
        assert len(channel.requests) == 1
        expected_request = logging_metrics_pb2.CreateLogMetricRequest(parent=parent, metric=metric)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
