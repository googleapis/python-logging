...
class ConfigServiceV2Transport(abc.ABC):
    ...
    def delete_bucket(
        ...
        [logging_config.DeleteBucketRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_view(
        ...
        [logging_config.DeleteViewRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_sink(
        ...
        [logging_config.DeleteSinkRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
