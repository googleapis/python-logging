...
LogSink = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      destination:
          ...
          with Sinks <https://cloud.google.com/logging/docs/api/tasks
          /exporting-logs>`__.
      filter:
      ...
      include_children:
          ...
          name:  ::     logName:("projects/test-project1/" OR "projects
...
BigQueryOptions = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      use_partitioned_tables:
          ...
          `special query syntax <https://cloud.google.com/bigquery/docs
          /querying-partitioned-tables>`__ has to be used instead. In
...
GetSinkRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      sink_name:
          ...
          "folders/[FOLDER_ID]/sinks/[SINK_ID]"  Example: ``"projects
...
UpdateCmekSettingsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      cmek_settings:
          ...
          Logs Router <https://cloud.google.com/logging/docs/routing
          /managed-encryption>`__ for more information.
      update_mask:
