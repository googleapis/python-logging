...
LogEntry = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      log_name:
          ...
          used in place of PROJECT\_ID. The project number is translated
          to its corresponding PROJECT\_ID internally and the
          ``log_name`` field will contain PROJECT\_ID in queries and
