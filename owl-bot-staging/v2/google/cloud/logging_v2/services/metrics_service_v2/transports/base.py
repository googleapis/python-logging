...
class MetricsServiceV2Transport(abc.ABC):
    ...
    @property
    def list_log_metrics(self) -> typing.Callable[
    ...
    @property
    def get_log_metric(self) -> typing.Callable[
            [logging_metrics.GetLogMetricRequest],
            typing.Union[
                logging_metrics.LogMetric,
                typing.Awaitable[logging_metrics.LogMetric]
            ]]:
        raise NotImplementedError()

    @property
    def create_log_metric(self) -> typing.Callable[
    ...
    @property
    def update_log_metric(self) -> typing.Callable[
    ...
    @property
    def delete_log_metric(self) -> typing.Callable[
