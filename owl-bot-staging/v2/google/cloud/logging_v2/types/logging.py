...
class WriteLogEntriesRequest(proto.Message):
    ...
    entries = proto.RepeatedField(proto.MESSAGE, number=4,
...
class WriteLogEntriesPartialErrors(proto.Message):
    ...
    log_entry_errors = proto.MapField(proto.INT32, proto.MESSAGE, number=1,
...
class ListMonitoredResourceDescriptorsResponse(proto.Message):
    ...
    resource_descriptors = proto.RepeatedField(proto.MESSAGE, number=1,
...
class TailLogEntriesRequest(proto.Message):
    ...
    buffer_window = proto.Field(proto.MESSAGE, number=3,
...
class TailLogEntriesResponse(proto.Message):
    ...
    class SuppressionInfo(proto.Message):
        ...
        reason = proto.Field(proto.ENUM, number=1,
    ...
    suppression_info = proto.RepeatedField(proto.MESSAGE, number=2,
